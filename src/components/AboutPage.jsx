...
function AboutPage() {
  const textSectionRef = intersectionObserver({ threshold: 0.1 });
  const hexagonSectionSmallRef = intersectionObserver({ threshold: 0.1 });
  const hexagonSectionLargeRef = intersectionObserver({ threshold: 0.1 });
      ...
      <div className='component-content-container about-page-content'>
        <div className='row h-100'>
          ...
          <div className='col-lg-6 col-md-12 col-sm-12 about-page-text-column'>
            <div
              className='d-flex flex-column about-page-text-section-width'
              ref={textSectionRef}
            >
              <h1 className='main-header'>Hey! I'm Sam Cole</h1>
              <h2
                className='sub-header standard-bottom-padding'
              ...
              <div
                className='d-flex flex-row justify-content-between standard-bottom-padding w-100 about-page-hexagon-section-small'
                ref={hexagonSectionSmallRef}
              >
          ...
          {/* Right Side Stats */}
          <div className='col-lg-6 col-md-12 col-sm-12 about-page-image-column about-page-hexagon-section' ref={hexagonSectionLargeRef}>
